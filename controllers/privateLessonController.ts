...
import PrivateLessonModel, { PrivateLessonInterface } from '../models/privateLessonModel';
...
const updatePrivateLesson = async (req: Request, res: Response) => {
  try {
    const updatedPrivateLesson = await PrivateLessonModel.findByIdAndUpdate(req.params.id, req.body, { new: true });
...
const deletePrivateLesson = async (req: Request, res: Response) => {
  try {
    const deletedPrivateLesson = await PrivateLessonModel.findByIdAndDelete(req.params.id);
...
export { getAllPrivateLessons, createPrivateLesson, getPrivateLessonById, updatePrivateLesson, deletePrivateLesson };
